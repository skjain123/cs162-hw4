 ...
 ***********************************************/
    ...
    /**************************************************
 * Name: exec()
 * Description: this function will execute the event. ex: confuse the player when encountering stalactite
 ...
 * Post-conditions: sets name to "stalactite"
 ***********************************************/
    Stalactite();
 ...
 * Parameters: string
 * Pre-conditions: constructor
 * Post-conditions: sets name to whatever stalactite
 ***********************************************/
    Stalactite(string);
