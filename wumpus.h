...
/**************************************************
 * Name: exec()
 * Description: this function will execute the event. ex: confuse the player when encountering wumpuss
 ...
 * Post-conditions: sets name to "wumpus"
 ***********************************************/
    Wumpus();
 ...
 * Parameters: string
 * Pre-conditions: constructor
 * Post-conditions: sets name to whatever wumpus
 ***********************************************/
    Wumpus(string);
